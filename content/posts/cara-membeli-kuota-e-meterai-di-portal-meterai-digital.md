...
> Ingin membeli **e-Meterai resmi dari Peruri** tanpa ribet?

Kini Anda dapat melakukannya **secara online** melalui portal [**Meterai Digital**](https://meterai.digital/) — platform resmi yang menyediakan layanan **pembelian dan pembubuhan e-Meterai** secara instan, aman, dan legal.

Melalui **Meterai Digital**, Anda bisa membeli kuota e-Meterai untuk kebutuhan pribadi, bisnis, atau dokumen hukum hanya dengan beberapa langkah mudah. Berikut panduan lengkapnya 👇

### Langkah 1 — Pilih Paket Kuota e-Meterai
...
Pastikan nominal sesuai dengan total pesanan Anda. Setelah membayar, klik tombol **"Cek Status Pembayaran"** untuk memastikan transaksi Anda sudah terverifikasi di sistem **Meterai Digital**.

### Langkah 3 — Cek Riwayat Pembelian dan Status Transaksi
...
Anda dapat melihat detail transaksi di menu **"Riwayat Pembelian"**, yang menampilkan **ID transaksi, jumlah, nominal, dan status pembayaran.** Klik **"Lihat Struk"** untuk menampilkan bukti pembelian e-Meterai Anda.

### Langkah 4 — Unduh Struk Pembelian e-Meterai

Halaman struk menampilkan seluruh detail pembelian, termasuk:

- Nomor transaksi dan tanggal pembelian
- Nama pembeli dan email
...
### Langkah 5 — Kuota e-Meterai Terupdate Otomatis
